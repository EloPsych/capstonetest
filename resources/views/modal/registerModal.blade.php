...
<div id="myModal" class="modal" style="display: none;">
    <div class="modal-content">
        ...
        <div class="mt-4">
            ...
            <select name="department" id="department" class="form-select rounded-md shadow-sm mt-1 block w-full" required>
                <option disabled selected>Select department</option>
                <option value="BFP">Bureau of Fire Protection</option>
                <option value="PDRRMC">Provincial Disaster Risk Reduction and Management</option>
