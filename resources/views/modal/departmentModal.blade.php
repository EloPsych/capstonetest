<!-- CSS -->
<link rel="stylesheet" href="{{ asset('css/departmentModal.css') }}">
        ...
        <section>
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    <form method="post" action="{{route('departments.store')}}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        ...
                        <div class="max-w-xl">
                            <header>
                                <img src="/img/BuildingLogo.png" alt="Logo" class="logo" style="width:110px; margin-left: 8vw">
...
<!-- Modal JavaScript-->
<script src="{{ asset('js/departmentModal.js') }}"></script>